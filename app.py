...
class Book(threading.Thread):
    ...
    def __init__(self):
        ...
        self.p_status = True # while True, parental settings is on
...
WEBUI_FOLDER = "/home/pi/Desktop/Internet-Radio-for-Kids/webui/"
app = Flask(__name__, static_folder= WEBUI_FOLDER + '/assets', template_folder=WEBUI_FOLDER + 'templates/')
curr = Book()

UPLOAD_FOLDER = "/home/pi/Desktop/Internet-Radio-for-Kids/uploads"
